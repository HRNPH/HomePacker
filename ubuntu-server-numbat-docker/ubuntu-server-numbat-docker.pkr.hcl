...
source "proxmox-iso" "ubuntu-server-numbat" {
    ...
    template_description = "Ubuntu Server numbat Image with 2G Swap and Docker"
    ...
    disks {
        ...
        # storage_pool_type = "lvm" # Deprecated
        type = "virtio"
    }
...
build {
    ...
    sources = ["source.proxmox-iso.ubuntu-server-numbat"]
